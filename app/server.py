...
species_details = {
    ...
    "acer_saccharinum": "commonly known as silver maple,creek maple, silverleaf maple, soft maple, large maple, water maple, swamp maple, or white maple. seeds are also a food source for squirrels, chipmunks and birds. The bark can be eaten by beaver and deer. produced before the leaves in early spring, with the seeds maturing in early summer. More: https://en.wikipedia.org/wiki/acer_saccharinum",
    ...
    "amelanchier_canadensis": "bilberry, Canadian serviceberry, chuckleberry, currant-tree, juneberry, shadblow serviceberry, shadblow, shadbush, shadbush serviceberry, sugarplum, thicket serviceberry). It is a deciduous shrub or small tree growing to 0.5–8 m tall. It is used as a medicinal plant,[6] food, and ornamental plant. It is sometimes made into bonsai",
    "betula_alleghaniensis": "the yellow birch or golden birch. prefers to grow in cooler conditions and is often found on north facing slopes, swamps, stream banks, and rich woods. most important species of birch for lumber and is the most important hardwood lumber tree in eastern Canada. In the past, yellow birch has been used for distilling wood alcohol, acetate of lime and for tar and oils. More https://en.wikipedia.org/wiki/Betula_alleghaniensis",
    "betula_nigra": "the black birch, river birch or water birch. is a deciduous tree growing to 25–30 meters (80–100 ft) with a trunk 50 to 150 centimeters (20 to 60 in) in diameter. making it a favored ornamental tree for landscape use. is not typically used in the commercial lumber industry, due to knotting, but its strong, closely grained wood is sometimes used for local furniture, woodenware, and fuel.This species is utilized by many local bird species, such as waterfowl, ruffed grouse, and wild turkey. More https://en.wikipedia.org/wiki/Betula_nigra",
